#
#  Be sure to run `pod spec lint rom-sdk-ios.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
  App Toolkit library check https://github.com/jiborobot/apptoolkit-swift-library
                   DESC
  ...
  s.source       = { :git => "https://github.com/jiborobot/apptoolkit-swift-library.git", :tag => s.version.to_s }
